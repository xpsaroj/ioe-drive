...
const DashboardActions = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-xl border border-border p-6">
            ...
            <div className="flex items-center justify-between gap-4 rounded-lg bg-background-tertiary px-4 py-3">
                <div className="flex items-center gap-3 min-w-0">
                    <span className="flex size-9 items-center justify-center rounded-full bg-background text-foreground shrink-0">
