...
export default function Navbar() {
  ...
  // Show Header for both logged-in and not logged-in users on the home page
  ...
  return (
    <>
      ...
      <div className={clsx(
        ...
        <div
          className={clsx(
            "container mx-auto p-2 flex items-center w-full md:gap-4 transition-all duration-400 ",
            shrink ? "py-0 -translate-2 transform scale-70 justify-center h-20" : "justify-between md:pt-2 h-32"
          )}
        >
          {/* Logo * Solved Jitter On Scroll*/}
          <div className={clsx(
            "transition-all duration-300",
            shrink ? "scale-70" : "scale-100"
          )}>
            <Logo size={6.5} />
          </div>
