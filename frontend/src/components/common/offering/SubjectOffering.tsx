...
const SubjectOffering = ({ offering }: { offering: SubjectOfferingWithSubject }) => {
    return (
        <div className="border p-8 rounded-xl shadow-sm bg-background space-y-8">
            <div className="mb-6">
            ...
            <div>
                <h3 className="text-lg mt-6">Offering Details</h3>
                <AcademicTermInfo
                    year={offering.year}
            ...
            <div>
                <h3 className="text-lg mt-6">Subject Details</h3>
                <Subject
